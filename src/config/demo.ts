...
export const demoAccounts = [
  { 
    ...
    password: import.meta.env.VITE_DEMO_ADMIN_PASSWORD || 'Demo123456!'
  },
  {
    role: 'Hospital Owner',
    email: import.meta.env.VITE_DEMO_OWNER_EMAIL || 'owner@metrogeneral.com',
    password: import.meta.env.VITE_DEMO_OWNER_PASSWORD || 'Demo123456!'
  },
  {
    role: 'Branch Manager',
    email: import.meta.env.VITE_DEMO_MANAGER_EMAIL || 'manager@metrogeneral.com',
    password: import.meta.env.VITE_DEMO_MANAGER_PASSWORD || 'Demo123456!'
  }
];